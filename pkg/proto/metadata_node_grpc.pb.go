...
func (c *metadataServiceClient) ProposeSet(ctx context.Context, in *ProposeSetRequest, opts ...grpc.CallOption) (*ProposeSetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProposeSetResponse)
	err := c.cc.Invoke(ctx, MetadataService_ProposeSet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metadataServiceClient) ProposeDelete(ctx context.Context, in *ProposeDeleteRequest, opts ...grpc.CallOption) (*ProposeDeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProposeDeleteResponse)
	err := c.cc.Invoke(ctx, MetadataService_ProposeDelete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMetadataServiceServer) ProposeSet(context.Context, *ProposeSetRequest) (*ProposeSetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProposeSet not implemented")
}
...
func _MetadataService_ProposeSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProposeSetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetadataServiceServer).ProposeSet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetadataService_ProposeSet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetadataServiceServer).ProposeSet(ctx, req.(*ProposeSetRequest))
	}
...
func _MetadataService_ProposeDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProposeDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetadataServiceServer).ProposeDelete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetadataService_ProposeDelete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetadataServiceServer).ProposeDelete(ctx, req.(*ProposeDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetadataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MetadataService_ProposeSet_Handler,
		},
		{
	...
	Metadata: "pkg/proto/metadata_node.proto",
}
